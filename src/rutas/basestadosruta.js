...
var EstadoModel = require('../Modelos/basestadosmodel');
...
module.exports = function () {
    ...
    router.get("/", function (req, res) {
        EstadoModel.getestado(function (error, data) {
    ...
    router.get("/:id", function (req, res) {
        ...
        if (!isNaN(id)) {
            EstadoModel.getestados(id, function (error, data) {
...
EstadoModel.insertEstado(TipEstado, function (error, data) {
...
EstadoModel.updateEstados(TipEstado, function (error, data) {
    //se muestra el mensaje correspondiente
    if (data && data.msg) {
        res.status(200).json(data);
    }
